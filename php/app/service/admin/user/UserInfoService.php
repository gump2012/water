...
class UserInfoService extends BaseService
{
    ...
    public function getUserIndex(): object
    {
        $result = User::with(['userRank' => function ($query) {
            ...
            ->field('user_id,username,nickname,avatar,rank_id,balance,points,mobile_validated,email_validated,is_svip,is_company_auth,water_tickets')->append(['dim_username'])->find($this->id);
    ...
    public function getBaseInfo(): array
    {
        ...
        $result = User::with(['userRank'])->field('user_id,username,nickname,avatar,points,balance,frozen_balance,birthday,mobile,email,rank_id,wechat_img,is_company_auth,water_tickets')
            ->append(['dim_username'])->find($this->id);
