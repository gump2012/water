<template>
    <view>
        <tig-navbar title="订水" :show-left="true" />
...
import search from "../productCate/src/search.vue";
import menuBox from "../productCate/src/menu.vue";
import selectCate from "../productCate/src/selectCate.vue";
