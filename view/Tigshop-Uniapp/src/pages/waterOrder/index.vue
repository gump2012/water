<template>
    <tig-layout>
        <view>
            <tig-navbar title="立即订水" :show-left="false" />
...
import search from "@/pages/productCate/src/search.vue";
import menuBox from "@/pages/productCate/src/menu.vue";
import selectCate from "@/pages/productCate/src/selectCate.vue";
...
const height = computed(() => {
    return `calc(${configStore.windowInfo.screenHeight}px - var(${tabbarStore.currentActiveValue > -1 ? "--tabbar-height" : "--safe-bottom"}) - var(--nav-height) - 90rpx)`;
});
</script>
